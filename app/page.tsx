    ...
    <main className="flex min-h-screen flex-col p-6 md:max-h-screen">
      ...
      <div className="mt-4 flex flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-mag px-6 py-10 md:w-1/5 md:px-20">
          ...
          <Link href="/register" className="flex items-center gap-5 self-start rounded-lg bg-blue-500 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-blue-400 md:text-base">
          ...
          <Image
            ...
            width={1000}
            height={500}
            className="hidden md:block max-w-full object-cover rounded-lg flex-grow"
          ...
          <Image
            ...
            width={560}
            height={620}
            className="block rounded-lg w-full md:hidden "
